...
REVISIÓN ADICIONAL (checklist unificado de la familia, a petición del cliente — repo 12/48):
...
- BUG REAL — botones del hero (.cta) con border-radius de 16px y sin
  ...
  filter:brightness(.88) en wa/pickup (ambos de color sólido) y
  relleno sólido con var(--deep) + texto blanco en el botón de
